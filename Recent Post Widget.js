...
.recent_posts_arlina .wrapinfo:before{content:"";z-index:1;height:100%;width:100%;background:rgba(0,0,0,0.2);opacity:0;position:absolute;top:0;left:0;border-radius:50%;transform:scale(0,0);transition:all .4s}
.recent_posts_arlina .wrapinfo:hover:before{opacity:1;transform:scale(1.5,1.5)}
...
ul.recent_posts_arlina li a{font-weight:400;line-height:normal}
</style>
<script style='text/javascript' src='https://rawgit.com/Arlina-Design/FlamingTree/master/recentpostarlina.js'></script>
